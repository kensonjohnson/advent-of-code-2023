...
The ferry quickly brings you across Island Island. After asking around, you discover that
 there is indeed normally a large pile of sand somewhere near here, but you don't see anything
  besides lots of water and the small island where the ferry has docked.
...
against the total race time. You can only hold the button at the start of the race, and boats 
...
ways you could win: you could hold the button for 2, 3, 4, or 5 milliseconds at the start of the race.
